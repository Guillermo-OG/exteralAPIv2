...
import { CreateOnboardingSchema } from '../utils/schemas/account/createOnboardingSchema'
...
export class OnboardingRouter {
    ...
    private config(): void {
        ...
        this.router.post('/create', this.validator.validate({ body: CreateOnboardingSchema }), this.controller.createOnboarding)
    }
}
